...
from .enrichment import EmailEnricher, ProfileBuilder
...
async def run_pipeline_async(
    ...
    *,
    ...
    profile_builder = ProfileBuilder(config.query.profile_enrichment)
    rows, profile_summary = await profile_builder.enrich_rows(rows)
    ...
    summary["profile_enrichment"] = profile_summary
    logger.info(
